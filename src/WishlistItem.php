...
class WishlistItem implements Arrayable, Jsonable
{
    /**
     * The rowID of the wishlist item.
     *
     * @var string
     */
    public $rowId;
    ...
    /**
     * The quantity for this wishlist item.
     *
     * @var int|float
     */
    public $qty;
    ...
    /**
     * The price without TAX of the wishlist item.
     *
     * @var float
     */
    public $price;
    ...
    /**
     * The options for this wishlist item.
     *
     * @var array
     */
    public $options;
    ...
    /**
     * The tax rate for the wishlist item.
     *
     * @var int|float
     */
    private $taxRate = 0;
    ...
    public function __construct($id, $name, $price, array $options = [])
    {
        ...
        $this->options  = new WishlistItemOptions($options);
    ...
    /**
     * Set the quantity for this wishlist item.
     *
     * @param int|float $qty
     */
    ...
    /**
     * Update the wishlist item from a Buyable.
     *
     * @param \Bhavinjr\Shoppingcart\Contracts\Buyable $item
     * @return void
     */
    ...
    /**
     * Update the wishlist item from an array.
     *
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->priceTax = $this->price + $this->tax;
        $this->options  = new WishlistItemOptions(array_get($attributes, 'options', $this->options));

        $this->rowId = $this->generateRowId($this->id, $this->options->all());
    }

    /**
     * Associate the wishlist item with the given model.
     *
     * @param mixed $model
     * @return \Bhavinjr\Shoppingcart\CartItem
     */
    ...
    /**
     * Get an attribute from the wishlist item or get the associated model.
     *
